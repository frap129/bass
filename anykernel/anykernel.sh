...
insert_line init.bass.rc "init.electron.rc" after "import init.bass.wifi.rc" "import init.electron.rc";
insert_line init.rc "disabled # electron" after "service flash_recovery /system/bin/install-recovery.sh" "electron";
